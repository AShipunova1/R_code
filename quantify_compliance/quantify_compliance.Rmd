...
sa_per_year_p <- percent_plot(sa_per_year, "year", my_regions[[2]])
sa_per_month_p <- percent_plot(sa_per_month, "year_month", my_regions[[2]])
sa_per_week_p <- percent_plot(sa_per_week, "week_start", my_regions[[2]])

gom_per_year_p <- percent_plot(gom_per_year, "year", my_regions[[1]])
gom_per_month_p <- percent_plot(gom_per_month, "year_month", my_regions[[1]])
gom_per_week_p <- percent_plot(gom_per_week, "week_start", my_regions[[1]])
```
