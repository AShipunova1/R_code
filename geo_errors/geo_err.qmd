...
trip_coord_info_map_data_sf_inland <-
  trip_coord_info_map_data_sf |>
  filter(lengths(
    sf::st_intersects(trip_coord_info_map_data_sf, us_polys)
  ) > 0)
...
dim(trip_coord_info_map_data_sf_inters)
# 0
sf::st_crs(usa_sf)
...
# Geometry type: POINT
sf::st_geometry(trip_coord_info_map_data_sf)
...
plot_us +
      ggplot2::geom_sf(data = trip_coord_info_map_data_sf,
                       color = "blue") 
