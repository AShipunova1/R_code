...
join_vesl_cnts_no_diff_ll_sf1 <-
  join_vesl_cnts_no_diff_ll_sf |>
  filter(lengths(
    sf::st_intersects(join_vesl_cnts_no_diff_ll_sf, usa_sf)
  ) == 0)

dim(join_vesl_cnts_no_diff_ll_sf1)
# [1] 3934    4

plot_us +
      ggplot2::geom_sf(data = join_vesl_cnts_no_diff_ll_sf1,
                       color = "blue") 
