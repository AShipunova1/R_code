...
```
### negative latitude fixed mapped
...
# Count vessels with bad vesl coords
...
# gg
```
## get Shapefile Coastal_County_Divisions_for_Shoreline_Cleanup_Operations
...
## get Shapefile USMaritimeLimitsNBoundaries
...
### Make the same crs for us_bb_border and federal_state_w_sf_east
...
### Make the same crs for us_bb_border and trip_coord_info_crop_big_sf
...
```{r On land polygons and points intersection (incl. state waters)}
## On land polygons and points intersection (incl. state waters) ----
...
```{r plot trip_coord_info_map_data_sf_inland}
### plot trip_coord_info_map_data_sf_inland ----
  ggplot() +
  geom_sf(
