save_and_write_to_google_sheets <- 
  function(current_result_google_ss_name = "Egregious Violators Current") {
  
  # my_current_ss contains information about the existing file
  my_current_ss <-
