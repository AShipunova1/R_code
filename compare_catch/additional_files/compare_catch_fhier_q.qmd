...
# view
logbooks_content_transmission_date_ok %>% select(starts_with("trip")) %>% str()

logbooks_content_transmission_date_ok_date_fixed_tmp <-
  logbooks_content_transmission_date_ok %>%
...
logbooks_content_transmission_date_ok_date_fixed <-
  logbooks_content_transmission_date_ok_date_fixed_tmp %>%
  # manually change the wrong value
  mutate(trip_end_date2 = ifelse(
    # find it
    grepl("1992", logbooks_content_transmission_date_ok_date_fixed_tmp$trip_end_date1),
    # change it
    "2022-10-16 01:00:00",
...
logbooks_content_transmission_date_ok_waves <-
  logbooks_content_transmission_date_ok_date_fixed %>%
