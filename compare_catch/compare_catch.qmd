...
fhier_mrip_catch_by_species_state_region_waves_list <-
  fhier_mrip_catch_by_species_state_region_waves %>%
  # split by sa/gom
...
#### 10 most frequent spp. GOM
```{r 10 most frequent spp. GOM}
n_most_frequent_fhier_10_list$gom %>% head()
```

#### 10 most frequent spp. SA
```{r 10 most frequent spp. SA}
...
### split
```{r no NA get 10 most frequent spp. by region}
...
n_most_frequent_fhier_10_list_no_na$gom %>% head()
```

#### No NAs 10 most frequent spp. SA
```{r No NAs 10 most frequent spp. SA}
n_most_frequent_fhier_10_list_no_na$sa %>% head()
...
#### No NAs Split by sa_gom column
```{r No NAs split by sa_gom column}
#| warning: false
...
fhier_mrip_catch_by_species_state_region_waves_no_na_for_plot_gom10 <-
  fhier_mrip_catch_by_species_state_region_waves_no_na_for_plot$gom %>%
  filter(species_itis %in% n_most_frequent_fhier_10_list$gom$species_itis)
# str(fhier_mrip_catch_by_species_state_region_waves_no_na_for_plot_gom10)
