...
fhier_catch_by_species_state_region_waves_list <-
  fhier_catch_by_species_state_region_waves %>%
  # split by sa/gom
  split(as.factor(fhier_catch_by_species_state_region_waves$end_port_sa_gom))
...
n_most_frequent_fhier_10_list <-
  ...
  map(function(x) {x %>%
      ...
      select(catch_species_itis, fhier_quantity_by_4) %>%
...
fhier_mrip_catch_by_species_state_region_waves_list_for_plot_gom10 <-
  fhier_mrip_catch_by_species_state_region_waves_list_for_plot$gom %>%
  filter(species_itis %in% n_most_frequent_fhier_10_list$gom$catch_species_itis)
# Rows: 217
...
fhier_mrip_catch_by_species_state_region_waves_list_for_plot_sa10 <-
  fhier_mrip_catch_by_species_state_region_waves_list_for_plot$sa %>%
  filter(species_itis %in% n_most_frequent_fhier_10_list$sa$catch_species_itis)
