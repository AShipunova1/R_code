...
temp_path <-
  file.path(r"(C:\Users\anna.shipunova\Downloads\drive-download-20240429T192631Z-001)")

input_path <- temp_path
  # file.path(annas_path$inputs, current_project_basename)
output_path <- temp_path
  # file.path(annas_path$outputs, current_project_basename)
processed_data_path <- temp_path
# annas_processed_data_path
sc_file_path <- temp_path
  # annas_sc_mismatch_file_path
srhs_2024_file_path <- temp_path
  # annas_srhs_2024_file_path
