...
```{r clean coordinates and cut by coordinate boundaries}
# clean coordinates and cut by coordinate boundaries ----
...
```{r a mapview with default options}
## a mapview with default options ----
mapview(lat_long_area_clean_sf)
```

## A mapview with custom options
```{r a mapview with custom options}
## a mapview with custom options ----
...
# Remove points falling into the GOM reef polygon
```{r remove points falling into GOM reef polygon}
...
## A mapview with custom options, new
```{r a mapview with custom options, new}
## a mapview with custom options ----
