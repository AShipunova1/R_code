...
trip_coord_info_vendors3 <-
  ...
  mutate(vendor_trip_cat = case_when(
    ...
    mutate(vendor_effort_cat = case_when(
  ...
  function(my_df,
    ...
    map_plot <-
      ...
      ggplot2::geom_sf_text(data = my_df_sf,
                            aes(label = vendor_trip_cat))
    
    # if (!is.na(label_columns)) {
      # map_plot <-
        # map_plot +
        # ggplot2::geom_sf_label(aes(label = vendor_trip_cat))
        # ggplot2::geom_text(aes(x = LONGITUDE,
        #                        y = LATITUDE,
        #                        label = my_df[[label_columns]]))
    # }
                           # 
