...
```{r no cache setup, results='hide', message=FALSE, warning=FALSE}
# setup ----
library(mapview)
library(ggplot2)
library(ggmap)
...
```{r get data, cache=TRUE, include=FALSE}
# get data ----
...
```{r Test polygons and points intersection, cache=TRUE}
...
```{r On land polygons and points intersection, cache=TRUE}
...
```{r On land polygons and points intersection plot, cache=TRUE}
