...
## On land polygons and points intersection
...
# Check if state waters are included
## Shapefile GOM
```{r get GOMsf}
path_to_GOMsf <-
...
## Not in SA and GOM
### Exclude sa and gom from us_bb
```{r exclude sa and gom from us_bb}

tic("sa_shp and us_bb difference")
not_sa_st_waters <-
...
not_sa_st_waters_gg <-
  ggplot() +
  ggplot2::geom_sf(data = not_sa_st_waters,
                   color = "red")
