...
"C:\Users\anna.shipunova\Documents\R_files_local\my_inputs\shapefiles\federal_and_state_waters_east\FederalandStat_east selection.shp"
...
trip_coord_info_short_sf <-
  ...
  sf::st_as_sf(
    coords = c("LONGITUDE",
               "LATITUDE"),
    crs = sf::st_crs(federal_state_waters_shp)
  )
...
### Inside SA and GOM ----
# too slow:
  # sf::st_intersection(trip_coord_info_crop_big_sf, sa_shp)

tic("in_sa_gom")
in_sa_gom <-
  crop_by_shape(trip_coord_info_crop_big_sf, federal_state_waters_shp)
toc()
# in_sa_gom: 1.53 sec elapsed

# 
# in_sa <-
#   crop_by_shape(trip_coord_info_crop_big_sf, sa_shp)
# 
# dim(in_sa)
# # [1] 32846     5
# 
