...
```{r statistics weird_stats 2}
rmarkdown::paged_table(head(weird_stats))


```

```{r statistics weird_stats 3, results='asis'}
library(knitr)
kable(head(weird_stats), caption = "results='asis'")


```


```{r statistics weird_stats 4}
library(knitr)
kable(head(weird_stats), caption = "UUUH")
